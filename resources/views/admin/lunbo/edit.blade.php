...
<html>
  ...
  <body>
      ...
      <div class="alert alert-danger" role="alert">
        <a href="/admin/lunbo/index" class="alert-link">{{session('error')}}</a>
      </div>
        
      @endif
    <div class="x-body">
        <form class="layui-form" enctype ="multipart/form-data" action="/admin/lunbo/update/{{$data->id}}" method="post">
          {{csrf_field()}}
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                ...
                <input type="radio" name="status" lay-skin="primary" title="停止" value="2">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <button  class="layui-btn" id="hui" lay-filter="add" lay-submit="">
                  返回
              </button>
          </div>
      </form>
    ...
    <script>
      $('#hui').click(function(){
        location.replace('/admin/lunbo/index');
        return false;
      })
