  ...
  <body>
    ...
    <div class="x-body">
      <xblock>
        ...
        <a href="/admin/per/create"><button class="layui-btn"><i class="layui-icon"></i>添加</button></a>
        ...
        <tbody>
          ...
          <tr>         
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','/admin/per/edit/{{$v->id}}')" href="javascript:;">
     ...
     /*用户-删除*/
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
            $.get('/admin/per/del/'+id,{},function(data){
                 //发异步删除数据
                console.log(data) 
                if(data){
