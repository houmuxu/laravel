...
<html>
  ...
  <body>
    @if(session('error'))
      ...
      @endif
    <div class="x-body">
        <form class="layui-form" action="/admin/sales" enctype ="multipart/form-data" method="post">
          {{csrf_field()}}
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="phone" name="oldprice" required="" 
                  autocomplete="off" class="layui-input">
              </div>
          </div>
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="phone" name="newprice" required="" 
                  autocomplete="off" class="layui-input">
              </div>
          </div>
