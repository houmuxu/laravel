...
<html>
  ...
  <body>
    @if(session('error'))
      ...
      @endif
    <div class="x-body">
        <form class="layui-form" action="/admin/sales/{{$data->sid}}" enctype ="multipart/form-data" method="post">
          {{csrf_field()}}
          {{method_field('PUT')}}
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="gname" value="{{$data->gname}}" required="" 
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="stock" value="{{$data->stock}}" required="" 
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="phone" name="oldprice" value="{{$data->oldprice}}" required="" 
                  autocomplete="off" class="layui-input">
              </div>
          </div>
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="phone" name="newprice" value="{{$data->newprice}}" required="" 
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="username" name="goodsattr" value="{{$data->goodsattr}}"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="file" id="file" multiple="multiple" name="salespic[]" required="" autocomplete="off" >
                        ...
                        <img src="
                         @php
                           $sid = App\Model\Admin\Salespic::where('sid',$data->sid)->first();
