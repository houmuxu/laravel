					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="{{$data->goodspics[0]->gpic}}"><img src="{{$data->goodspics[0]->gpic}}" alt="细节展示放大镜特效" rel="{{$data->goodspics[0]->gpic}}" class="jqzoom" /></a>
							</div>
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								...
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">{{$data->price+10}}</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
							...
							<ul class="tm-ind-panel">
								<li class="tm-ind-item tm-ind-sellCount canClick">
									<div class="tm-indcon"><span class="tm-label">月销量</span><span class="tm-count">{{$data->num}}</span></div>
								</li>
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count">{{$data->num}}</span></div>
								</li>
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<dd>
															...
															<span id="Stock" class="tb-hidden">库存<span class="stock">{{$data->stock}}</span>件</span>
														</dd>
							...
							<div class="am-tabs-bd">
								...
								<div class="am-tab-panel am-fade am-in am-active">
									<div class="J_Brand">
										...
										<li id="J_AttrUL"><img src="//img.alicdn.com/tps/i1/T1DiulXX0sXXXXXXXX-16-17.png">商品具有<a target="_blank" href="//baike.taobao.com/view.htm?tp=18&amp;wd=SC11834020305037"><b style="color:#35a">生产许可证编号</b></a>，符合食品质量安全准入标准。</li>
										...
										<div class="clear"></div>
										<ul id="J_AttrUL">
											<li title="">生产许可证编号:&nbsp;SC11834020305037</li>
											<li title="">产品标准号:&nbsp;GB 19300</li>
											<li title="">厂名:&nbsp;三只松鼠股份有限公司</li>
											<li title="">厂址:&nbsp;安徽省芜湖市弋江区芜湖高新技术...</li>
											<li title="">厂家联系方式:&nbsp;400-800-4900</li>
											<li title="">配料表:&nbsp;扁核桃，白砂糖，食用盐，甜炼...</li>
											<li title="">储藏方法:&nbsp;请置于阴凉干燥处</li>
											<li title="">保质期：&nbsp;240 天</li>
											<li title="">食品添加剂：&nbsp;甜蜜素，安赛蜜，糖精钠 </li>
											<li title="">包装方式：&nbsp;包装</li>
											<li title="">品牌：&nbsp; Three Squirrels/三只松鼠</li>
											<li title="">产地：&nbsp;中国大陆</li>
											<li title="">是否新货：&nbsp;是</li>
										</ul>
										<div class="clear"></div>
